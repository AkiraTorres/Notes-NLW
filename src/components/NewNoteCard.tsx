    ...
    return (
        <Dialog.Root>
            ...
            <Dialog.Portal>
                ...
                <Dialog.DialogContent className="fixed left-1/2 top-1/2 overflow-hidden -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none">
                ...
                <form onSubmit={handleSaveNote} className="flex-1 flex flex-col">
                    ...
                    {shouldShowOnboarding ? (
                        ...
                        <p>
                            <textarea
                                autoFocus
                                className="text-sm leading-6 text-slate-400 bg-transparent resize-none flex-1 outline-none w-[100%]"
